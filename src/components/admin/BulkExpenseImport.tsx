...
export function BulkExpenseImport({
  ...
  if (role !== "admin") {
    return (
      <p className="py-10 text-center text-brand-green-dark/50">
        Only admins can bulk upload expenses.
      </p>
    );
  }
  ...
  const handleDownloadTemplate = async () => {
    setDownloading(true);
    try {
      const payload: Record<string, any> = { password, action: "expenseTemplate" };
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-brand-green-dark/60">
              ...
              expense data, then upload it below.
            </p>
            <div className="mt-3">
              <Button
                type="button"
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-brand-green-dark/60">
              ...
              duplicates, and insert new expense records.
            </p>
          </div>
        </div>
        ...
        >
          {file ? (
            ...
            <>
              ...
              <label
                htmlFor="bulk-expense-import-file"
      ...
      <div className="rounded-xl bg-brand-sand/50 p-4 text-xs text-brand-green-dark/60">
        ...
        <ul className="mt-1 list-inside list-disc space-y-0.5">
          ...
          <li>For online payments, provide account_name matching an existing account</li>
          <li>Amounts should be in rupees (e.g. 500 for ₹500)</li>
          <li>
            <strong>Safe retries:</strong> Re-uploading the same file skips
            already-imported rows (matched by date + amount + category + notes)
          </li>
        </ul>
      </div>
    </div>
