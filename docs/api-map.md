...
| `/api/aiosell/push-noshow` | user auth | No-show |
...
**Expenses:** `addExpense`, `listExpenses`, `getMyExpenses`, `updateExpense`, `deleteExpense`, `getFoodRevenue`, `getDailyLedger`, `addDailyIncome`, `deleteDailyIncome`, `getReconciliation`, `saveReconciliation`, `undoReconciliation`, `adjustOpeningBalance`.
